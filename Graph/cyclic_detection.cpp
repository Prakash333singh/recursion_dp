...
// bool isCycleDfs(vector<int> adj[], int u, vector<bool> &visited)
// {
...
// 3.cycle detection using dfs in directed graph
...
// 4. detecting using bfs in directed graph using topological sort(khans algo)
// topological algo
