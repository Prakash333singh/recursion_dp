...
// Encapsulation(it is also called data hiding)
// wrapping up of data and information in a single unit ,while controlling access to them which we keep our variables private and control them with the help of functions
